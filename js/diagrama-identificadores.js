	...
	function getContactTemplate() {
		...
		var itemTemplate = jQuery(
			'<div class="bp-item bp-corner-all bt-item-frame">'
				+ '<div name="titleBackground" class="bp-item bp-corner-all bp-title-frame" style="background:{{itemConfig.itemTitleColor}};top: 2px; left: 2px; width: 177px; height: 25px;">'
					+ '<div name="title" class="bp-item bp-title" style="top: 4px; left: 6px; width: 186px; height: 25px;">{{itemConfig.title}}</div>'
				+ '</div>'
				...
				+ '</div>'
				+ '<div class="bp-item" style="top: 30px; width: 186px; height: 70px; padding: 5px">'
					+ '<div ng-repeat="item in itemConfig.asociados" style="color: #fff; display: inline; background: {{items_l[item].itemTitleColor}}; border: 1px solid; border-radius: 4px; padding: 2px; width: 25px; height: 23px; margin: 2px;">'
